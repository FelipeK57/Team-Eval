...
urlpatterns = [
    ...
    path('CursosGrupo/', views.curso_estudiantes_en_grupo),
    path('AgregarEstudianteGrupo/', views.agregar_estudiante_a_grupo),
    re_path(r'^estudiantesCurso/$', views.estudiantesCurso),
